...
CREATE TABLE info (
  ...
  wheelchair boolean,
  kids boolean,
  groups boolean, /*syntax error starts here*/
  attire varchar(50),
  ambience varchar(50),
...
/*
-- INSERT INTO info (reservations, delivery, takeOut, credit, applePay, googlePay, bitcoin, goodFor, parking, bike, wheelchair, kids, groups, attire, ambience, noise, alcohol, outdoor, wifi, tv, dogs, waiter, caters, bathrooms) values(false, true, true, true, true, false, false, 'lunch and dinner', 'Street', false, true, true, true, 'casual', 'casual', 'ambient', 'wine', false, true, false, false, true, false, true);
*/
