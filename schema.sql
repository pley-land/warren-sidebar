...
-- maybe there's a reserved keyword in use?
CREATE TABLE info (
  id int NOT NULL AUTO_INCREMENT,
  ...
  wheelchair boolean,
  kids boolean,
  accepts_groups boolean, /*syntax error starts here*/  
  attire varchar(50),
  ambience varchar(50),
  noise varchar(50), /*syntax error ends here*/
  alcohol varchar(50),
  outdoor boolean,
  wifi boolean,
  tv boolean,
...
/*
-- INSERT INTO info (reservations, delivery, takeOut, credit, applePay, googlePay, bitcoin, goodFor, parking, bike, wheelchair, kids, accepts_groups, attire, ambience, noise, alcohol, outdoor, wifi, tv, dogs, waiter, caters, bathrooms) values(false, true, true, true, true, false, false, 'lunch and dinner', 'Street', false, true, true, true, 'casual', 'casual', 'ambient', 'wine', false, true, false, false, true, false, true);
*/
